 ...
 **/
GPB_FINAL @interface SVGAProtoSvgaRoot : GPBRootObject
@end
...
GPB_FINAL @interface SVGAProtoMovieParams : GPBMessage
...
GPB_FINAL @interface SVGAProtoSpriteEntity : GPBMessage
...
/** The number of items in @c framesArray without causing the container to be created. */
...
GPB_FINAL @interface SVGAProtoAudioEntity : GPBMessage
...
GPB_FINAL @interface SVGAProtoLayout : GPBMessage
...
GPB_FINAL @interface SVGAProtoTransform : GPBMessage
...
GPB_FINAL @interface SVGAProtoShapeEntity : GPBMessage
...
GPB_FINAL @interface SVGAProtoShapeEntity_ShapeArgs : GPBMessage
...
GPB_FINAL @interface SVGAProtoShapeEntity_RectArgs : GPBMessage
...
GPB_FINAL @interface SVGAProtoShapeEntity_EllipseArgs : GPBMessage
...
GPB_FINAL @interface SVGAProtoShapeEntity_ShapeStyle : GPBMessage
...
GPB_FINAL @interface SVGAProtoShapeEntity_ShapeStyle_RGBAColor : GPBMessage
...
GPB_FINAL @interface SVGAProtoFrameEntity : GPBMessage
...
/** The number of items in @c shapesArray without causing the container to be created. */
...
GPB_FINAL @interface SVGAProtoMovieEntity : GPBMessage
...
/** The number of items in @c images without causing the container to be created. */
...
/** The number of items in @c spritesArray without causing the container to be created. */
...
/** The number of items in @c audiosArray without causing the container to be created. */
